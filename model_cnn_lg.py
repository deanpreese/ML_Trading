...
from ml_model.k_model_base import FFTLayer, FFTOrRFTLayer
...
class CNN_LG (K_MODEL_BASE):
    ...
    def build_model_hfft(self, inputs):
        ...
        h = FFTOrRFTLayer(use_rft=True, return_magnitude=True)(inputs)
        h2 = FFTOrRFTLayer(use_rft=True, return_magnitude=True)(inputs)
...
def main():
    ...
    model = CNN_LG('cnn_lg_lucky13_all_ave')
