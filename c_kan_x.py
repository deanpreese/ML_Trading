...
def evaluate_model(model, X_train, y_train, X_val, y_val, X_test, y_test, y_pred):
...
def main():
    ...
    train_mae, val_mae, test_mae = evaluate_model(best_model, X_train, y_train, X_val, y_val, X_test, y_test, y_pred)
