...
def main(input_chunk_length, output_chunk_length):
    ...
    #list_f = ['RSI','SDBB91','SDLR310', 'ROC', 'outputC']
    #data = data[list_f]
    ...
    #list_LSTM =['SDLR310','ATR2','RSI','STOK7217','SDBB9','STOD7217','outputC']
    #data = data[list_LSTM]
       
    
    #file_path = 'data/Ind_F_1M.csv'    
    #file_path = 'data/Ind_F.csv'
    #data = pd.read_csv(file_path)
    #data = data.drop(columns=['output'])

    #list_F2 = ['STOK7217','LR1033','LR813','LR2155', 'outputC']
          
    list_1m = ['BB14', 'CCI20', 'LR310', 'OBV', 'ROC7', 'ROC9', 'RSI14', 
               'RSI3', 'SDKC14', 'SDKC7', 'STOK7217', 'ATR2', 'LR2155', 'RSI9', 'SDKC9', 
               'STOD15657', 'STOK15657', 'VOSC20', 'VOSC7', 'VOSC9', 'outputC']
          
    listX2 = ['CCI20', 'ATR2', 'CCI9', 'RSI3', 'RSI9', 'VOSC7', 'STOK15657', 'STOD15657', 'ADX9', 
             'LR2155',  'BB7','LR1033', 'ROC9', 'SDKC9', 'BB14','LR813','outputC']
    
    listX = [ 'CCI20', 'ATR2', 'CCI9', 'RSI3',   'RSI9',  'VOSC7', 'STOK15657', 
             'STOD15657',  'LR1033', 'ROC9', 'SDKC9', 'BB14',
              # 'ADX20',  # 'STOD7217',  # 'STOK7217',  # 'SDKC9', 
              # 'RSI14',# 'VOSC9',   # 'SDKC14',  # 'ADX14', 
              #'LR813',   #'BB9',  #'ROC7', #'SDKC14', #'LR310',
              'outputC']
    ...
    predict_data2 = [forecast_results_lgb2, forecast_results_xgb2, forecast_results_cat2]
    predict_data3 = [forecast_results_xgb2, forecast_results_xgb ] #***
    
    #predict_data4 = [forecast_results_lgb2, forecast_results_lgb, forecast_results_cat2,forecast_results_xgb, forecast_results_xgb2 ]
    #predict_data5 = [forecast_results_cat, forecast_results_cat2, forecast_results_lgb, forecast_results_xgb ]
    
    predict_data6 = [forecast_results_xgb, forecast_results_xgb2, forecast_results_cat2 ] #***
    
    #predict_data7 = [forecast_results_xgb2, forecast_results_xgb, forecast_results_lgb2, forecast_results_lgb ] 
    #predict_data8 = [forecast_results_xgb2, forecast_results_lgb, forecast_results_cat, forecast_results_cat2 ]
    ...
    #perf_ave, perf_maj, perf_cc, total = ensemble_model(predict_data5, y_test, forecast_results_len)
    perf_ave, perf_maj, perf_cc, total = ensemble_model(predict_data6, y_test, forecast_results_len)
    #perf_ave, perf_maj, perf_cc, total = ensemble_model(predict_data7, y_test, forecast_results_len)
    #perf_ave, perf_maj, perf_cc, total = ensemble_model(predict_data8, y_test, forecast_results_len)
